...
std::vector<std::vector<std::pair<std::string,double>>> get_mnemonic( ///> time(tics(tic,fv)))
std::map< std::string, std::vector< std::map< std::string, double> > > tmd, std::string mnemonic) {
  using namespace std;
